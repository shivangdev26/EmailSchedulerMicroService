          ...
          try {
            ...
            if (token) {
              ...
              if (freshActionData) {
                ...
                logger.warn(
                  "Could not extract fresh action data from API response",
                  { data: response.data },
                );
              }
              ...
              try {
                ...
                if (tblData.length > 0) {
                  ...
                  for (const key of Object.keys(tblData[0])) {
                    const val =
                      tblData[0][key] !== null && tblData[0][key] !== undefined
                        ? String(tblData[0][key])
                        : "";
                ...
                console.error(
                  "Error fetching container_no and remarks:",
                  err.message,
                );
              }
            }
