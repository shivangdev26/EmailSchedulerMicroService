...
const alertQueueName = process.env.ALERT_QUEUE_NAME || "alert-scheduler";
const alertQueue = new Queue(alertQueueName, {
  connection,
  defaultJobOptions: {
    removeOnComplete: false,
    removeOnFail: false,
...
module.exports = { connection, emailQueue, emailQueueName, alertQueue, alertQueueName };
