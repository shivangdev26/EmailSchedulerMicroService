...
// // } = require("./workers/emailSchedulerWorker");

// const { initializeEmailWorker } = require("./workers/emailSchedulerWorker");
...
//     try {
//       await closeEmailSchedulerWorker();
//       await connection.quit();

//       console.log("BullMQ connections closed successfully");
//       process.exit(0);
//     } catch (error) {
//       console.log("Error during BullMQ disconnection:", error);
//       process.exit(1);
//     }
//   });
